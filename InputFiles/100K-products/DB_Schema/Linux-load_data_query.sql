...
LOAD DATA LOCAL INFILE  '/home/grads/antreasp/kostakis/InputFiles/100K-products/Data/products.csv'
INTO TABLE products FIELDS TERMINATED BY ',' LINES TERMINATED BY '\r\n'  IGNORE 1 LINES
(
    product_id, name, price, subcategory, category
);

LOAD DATA LOCAL INFILE  '/home/grads/antreasp/kostakis/InputFiles/100K-products/Data/dates.csv'
...
LOAD DATA LOCAL INFILE  '/home/grads/antreasp/kostakis/InputFiles/100K-products/Data/locations.csv'
INTO TABLE locations FIELDS TERMINATED BY ',' LINES TERMINATED BY '\r\n' IGNORE 1 LINES
(
    location_id, city, state
);

LOAD DATA LOCAL INFILE  '/home/grads/antreasp/kostakis/InputFiles/100K-products/Data/sales.csv'
