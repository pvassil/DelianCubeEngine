...
public class MainAppSparkController extends AbstractController implements Initializable{
	@FXML
	...
	public MainAppSparkController(Boolean serverStatus, IMainEngine service) {
		super();
	...
	public void connectDB(ActionEvent event) throws InterruptedException{
		...
		try {
			service.initializeSpark(schemaTextField.getText(), inputFolderTextField.getText(), cubeTextField.getText());
		} catch (RemoteException e) {
			e.printStackTrace();
		}
