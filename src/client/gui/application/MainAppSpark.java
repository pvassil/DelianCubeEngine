...
import client.gui.controllers.MainAppSparkController;
...
public class MainAppSpark extends AbstractApplication {
...
//			System.exit(-100);
		...
		MainAppSparkController controller = new MainAppSparkController(serverStatus, service);
		...
		launchResult = launcher.launchViewControllerPairNoFXController(this, null, primaryStage, false, 
				"MainAppSpark.fxml", controller, rootLayout);
